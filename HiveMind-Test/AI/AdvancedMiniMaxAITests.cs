...
{
	[TestFixture()]
	public class AdvancedMiniMaxAITests {

		[Test]
		public void TestCanDetectWinTurnOne() 
		{
			HiveAI ai = new AdvancedMiniMaxAI("AdvancedAlphaBeta", new SimpleHeuristic(), 1, 30000);
		...
		public void TestCanDetectWinTurnTwo() {
			HiveAI ai = new AdvancedMiniMaxAI("AdvancedAlphaBeta", new SimpleHeuristic(), 3, 30000);
